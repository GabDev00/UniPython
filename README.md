...
<sup>Aula 3 - Construção de algoritmos baseados em lógica</sup>  
<sup>Aula 4 - Solução de problemas com pensamento computacional</sup>  
...
=======
# UniFecaf-Python
Algoritmos e lógica de programação desenvolvidos na graduação de Ciência da Computação.
